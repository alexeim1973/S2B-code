...
def RenderDensity(x,y,vz,plt_title,cbar_label):
    ...
    print('Elapsed time (hh:mm:ss.ms) {}'.format(time_elapsed))
    print()
    plot_data(xmid, ymid, z, plt_title, cbar_label)
        
def RenderMoment(m,x,y,vz,plt_title,cbar_label):
...
def plot_data(xmid, ymid, z, plt_title, cbar_label):
