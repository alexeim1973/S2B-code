...
data_fname_csv = "/home/ubuntu/projects/S2B/GaiaChallenge/modelR1GaiaChallenge.csv"
...
def RenderDensity(x, y, vz, xlim, ylim, plt_title, cbar_label):
    ...
    print('Elapsed time (hh:mm:ss.ms) {}'.format(time_elapsed))
    print()
    plot_data(xlim, ylim, xmid, ymid, z, plt_title, cbar_label)
        
def RenderMoment(m, x, y, vz, xlim, ylim, plt_title, cbar_label):
...
def plot_data(xlim, ylim, xmid, ymid, z, plt_title, cbar_label):
